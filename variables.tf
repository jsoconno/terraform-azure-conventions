variable "region" {
  ...
  validation {
    condition = (
      contains(["a", "ap", "as", "asc", "asc2", "ase", "ass", "b", "bs", "bse", "c", "cc", "ce", "ci", "cus", "cuse", "ea", "eus", "eus2", "eus2e", "e", "f", "fc", "fs", "ger", "gn", "gwc", "glob", "i", "j", "je", "jw", "jic", "jiw", "k", "kc", "ks", "ncus", "ne", "n", "nwe", "nw", "sa", "san", "saw", "scus", "si", "sea", "sc", "s", "sn", "sw", "uc", "un", "uks", "ukw", "uae", "uk", "us", "wcus", "we", "wi", "wus", "wus2", "wus3"], var.region)
    )
...
variable "environment" {
  ...
  validation {
    condition = (
      contains(["x", "d", "t", "q", "u", "s", "p"], var.environment)
    )
